...
- [와이어프레임 1차 제작 완료](#와이어프레임-1차-제작-완료)
  - [Adobe Xd 툴 느낀점](#adobe-xd-툴-느낀점)
  - [페이지 수와 기능의 수가 곧 인건비다](#페이지-수와-기능의-수가-곧-인건비다)
  - [결과물](#결과물)
- [와이어프레임 검수 받았다](#와이어프레임-검수-받았다)
  - [사용자 경험을 해치지 않는 선에서 개발 비용 절감을 고민하기](#사용자-경험을-해치지-않는-선에서-개발-비용-절감을-고민하기)
  - [문제 정의 > 인식 > 해결](#문제-정의--인식--해결)
- [잡설](#잡설)
...
멘토분께 아래와 같은 내용으로 피드백을 받았다.

### 사용자 경험을 해치지 않는 선에서 개발 비용 절감을 고민하기
...
- 2페이지 메뉴 화면
  - 페이지를 삭제하고 플로팅 메뉴로 바꾼다
  - 프로필 설정을 환경 설정 메뉴로 옮긴다
  - 프로필은 리포트 상단으로 옮긴다
- 일간-주간-전체 리포트
  - adobe xd single page, one page 등으로 검색함
  - [해결책 - 가로 스크롤과 앵커 링크(adobe xd 튜토리얼)](https://helpx.adobe.com/kr/xd/help/use-anchor-links-to-create-navigation-link-XD.html)
  - 상단에 프로필 만들고
  - 하단에 메뉴들 플로팅 메뉴로 옮긴다(설정, 화면기록, 가이드)
- 팝업이 많다
  - 컴포넌트 나열보다 구체적인 항목을 도출해야함
